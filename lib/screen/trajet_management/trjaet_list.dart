...
// });
    Widget showModifyDeparture(){
      return Obx(() {
          if (selected_horaires == 0 && selected_trajet == 0 || DataController.instance.trajets
                                .firstWhere((element) =>
              ...
              ? Column(
                  children: [
                    ...
                    CupertinoButton(
                        ...
                        onPressed: () {
                          DataController.instance.updateHoraire(Horaire(id: hora.id,trajet_id: selected_trajet.value, nombrePlace: int.parse(nombre_place_controller.text), userCreated: hora.userCreated, dateCreated: hora.dateCreated, userUpdated: AuthController.instance.user.value!.id, dateUpdated: DateTime.now(), heureDepart: heure_depart_controller.text, jourDeDisponibilite: selected_days.value));
          ...
          return Column(
                  children: [
                    ...
                    CupertinoButton(
                        ...
                        onPressed: () {
                          print(selected_days);
                          DataController.instance.addHoraire(Horaire(id: 0,trajet_id: selected_trajet.value, nombrePlace: int.parse(nombre_place_controller.text), userCreated: AuthController.instance.user.value!.id!, dateCreated: DateTime.now(), userUpdated: AuthController.instance.user.value!.id, dateUpdated: DateTime.now(), heureDepart: heure_depart_controller.text, jourDeDisponibilite: selected_days.value));
                          nombre_place_controller.clear();
                          selected_days.clear();
                          heure_depart_controller.clear();
                          selected_horaires.value = 0;
        ...
        child: Column(
          ...
          children: [
             Text(
                    ...
                    Text("Prix d'une place",style: mediumTitle,),
                    SizedBox(
                      width: Get.width*0.8,
                      child: TextField(
                    ...
                    const SizedBox(
                      ...
                      Text("Choisir la ville d'arrive",style: mediumTitle,),
                    ...
                    Text("Choisir la Gare d'arrive",style: mediumTitle,),

                    DropdownButtonFormField(items: DataController.instance.gares.map((e)=> DropdownMenuItem(child: Text("${e.nom}-${e.ville}" ),value: e.id,)).toList()
                    ...
                    Center(
                      child: CupertinoButton(child: Text("Ajouter",style: mediumTitle.copyWith(color: Colors.white),),color: Colors.green, onPressed: ()async{
                        await DataController.instance.addTrajet(Trajet(id: 0, userCreated: AuthController.instance.user.value!.id!, dateCreated: DateTime.now(), userUpdated: AuthController.instance.user.value!.id!, dateUpdated: DateTime.now(), prix: 5000, gareDeDepart: AuthController.instance.user.value!.gareId!, villeDepart: "OUAGADOUGOU", villeArrive: "KAYA", horaires: []));
                        screenToShow.value="";
                      }),
                    )
              ...
              child: Obx(
                () => ListView.builder(
                    ...
                    itemBuilder: (context, index) {
                      ...
                      return Obx(() => ListTile(
                        tileColor: selected_trajet.value == trj.id? Colors.green:Colors.red,
                            onTap: () {
                        ...
                        () => ListView.builder(
                            ...
                            itemBuilder: (context, index) {
                              ...
                              screenToShow.value ="";
                                  ...
                                  leading: CircleAvatar(
                                    backgroundColor: trj.id == selected_horaires.value?Colors.green:null,
                                    child: Text(
                                      "${trj.heureDepart}",
                                    ),
                                  ),
    ...
    PanelRightScreen() {
      return Container(
              ...
              child: Obx(() {
                ...
                }else if(selected_horaires.value != 0 && selected_trajet.value != 0){
